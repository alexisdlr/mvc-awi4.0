...
<ul> 
  ...
  <li>Navigate to the api folder and run 'npm install' to install all the dependencies.</li>
  <li>You need to create a mysql database and import the db.sql file from the api folder</li>
  <li>You need to initialize mysql server on port 3308</li>
  <li>run the command yarn start on both folders</li>
</ul>
